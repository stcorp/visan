...
# for that product plot the first sun reference spectrum
...
def run():
    ...
    product = harp.import_product(files[0], "", "data=sun_reference")

    plot(product, name=os.path.basename(files[0]), title="GOME_L1 reference spectrum example")
